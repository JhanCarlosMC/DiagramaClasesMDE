...
public class BdPackageImpl extends EPackageImpl implements BdPackage {
	 ...
	 * @generated
	 */
	public EReference getTable_ListIndexes() {
	 ...
	 * @generated
	 */
	public EAttribute getColumn_UniqueData() {
	 ...
	 * @generated
	 */
	public EReference getForeignKey_TableReferenced() {
	...
	public void createPackageContents() {
		...
		createEAttribute(columnEClass, COLUMN__UNIQUE_DATA);
		...
		createEReference(foreignKeyEClass, FOREIGN_KEY__TABLE_REFERENCED);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getIndex_Type(), ecorePackage.getEString(), "type", null, 0, 1, Index.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getColumn_UniqueData(), ecorePackage.getEBoolean(), "uniqueData", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPrimaryKey_Type(), ecorePackage.getEString(), "type", null, 0, 1, PrimaryKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPrimaryKey_AutoIncrement(), ecorePackage.getEBoolean(), "autoIncrement", null, 0, 1, PrimaryKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(foreignKeyEClass, ForeignKey.class, "ForeignKey", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getForeignKey_TableReferenced(), this.getTable(), null, "tableReferenced", null, 0, 1, ForeignKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
