...
public class BdFactoryImpl extends EFactoryImpl implements BdFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case BdPackage.MODEL_FACTORY: return createModelFactory();
			case BdPackage.SCHEMA: return createSchema();
			case BdPackage.TABLE: return createTable();
			case BdPackage.INDEX: return createIndex();
			case BdPackage.COLUMN: return createColumn();
			case BdPackage.RELATION: return createRelation();
			case BdPackage.TRIGGER: return createTrigger();
			case BdPackage.PRIMARY_KEY: return createPrimaryKey();
			case BdPackage.FOREIGN_KEY: return createForeignKey();
			default:
