...
import bd.diagram.edit.policies.BdTextSelectionEditPolicy;
...
public class TableNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new BdTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return BdElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = BdParserProvider.getParser(BdElementTypes.Table_2001, getParserElement(),
					BdVisualIDRegistry.getType(bd.diagram.edit.parts.TableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, BdEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
