...
/**
 * This is the item provider adapter for a {@link concreta.MKJClase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MKJClaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MKJClase_identificador_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MKJClase_identificador_feature", "_UI_MKJClase_type"),
				 ConcretaPackage.Literals.MKJ_CLASE__IDENTIFICADOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConcretaPackage.Literals.MKJ_CLASE__ATRIBUTOS);
			childrenFeatures.add(ConcretaPackage.Literals.MKJ_CLASE__METODOS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcretaPackage.Literals.MKJ_CLASE__ATRIBUTOS,
				 ConcretaFactory.eINSTANCE.createMKJAtributo()));

		newChildDescriptors.add
			(createChildParameter
				(ConcretaPackage.Literals.MKJ_CLASE__METODOS,
				 ConcretaFactory.eINSTANCE.createMKJMetodo()));
	}
