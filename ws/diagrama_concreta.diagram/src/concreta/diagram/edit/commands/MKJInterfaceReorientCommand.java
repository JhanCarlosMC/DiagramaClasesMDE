 ...
 * @generated
 */
public class MKJInterfaceReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public MKJInterfaceReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof MKJInterface) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcretaBaseItemSemanticEditPolicy.getLinkConstraints().canExistMKJInterface_4005(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected MKJInterface getLink() {
		return (MKJInterface) getElementToEdit();
	}
