 ...
 * @generated
 */
public class MKJConteinmentReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public MKJConteinmentReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof MKJConteinment) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcretaBaseItemSemanticEditPolicy.getLinkConstraints().canExistMKJConteinment_4002(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected MKJConteinment getLink() {
		return (MKJConteinment) getElementToEdit();
	}
