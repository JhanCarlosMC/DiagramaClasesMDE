 ...
 * @generated
 */
public class MKJAgregacionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public MKJAgregacionReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof MKJAgregacion) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcretaBaseItemSemanticEditPolicy.getLinkConstraints().canExistMKJAgregacion_4003(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected MKJAgregacion getLink() {
		return (MKJAgregacion) getElementToEdit();
	}
