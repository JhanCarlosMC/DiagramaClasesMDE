 ...
 * @generated
 */
public class MKJAsociacionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public MKJAsociacionReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof MKJAsociacion) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcretaBaseItemSemanticEditPolicy.getLinkConstraints().canExistMKJAsociacion_4001(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected MKJAsociacion getLink() {
		return (MKJAsociacion) getElementToEdit();
	}
