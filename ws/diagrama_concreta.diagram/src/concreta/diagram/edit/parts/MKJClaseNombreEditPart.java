 ...
 * @generated
 */
public class MKJClaseNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MKJClaseNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MKJClase_2001, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MKJClaseNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
