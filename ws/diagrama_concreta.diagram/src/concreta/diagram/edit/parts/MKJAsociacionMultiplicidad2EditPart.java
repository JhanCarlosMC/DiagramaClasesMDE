 ...
 * @generated
 */
public class MKJAsociacionMultiplicidad2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ConcretaVisualIDRegistry
				.getType(concreta.diagram.edit.parts.MKJAsociacionMultiplicidad2EditPart.VISUAL_ID), new Point(50, -5));
	}

	/**
	* @generated
	*/
	public MKJAsociacionMultiplicidad2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MKJAsociacion_4001, getParserElement(),
					ConcretaVisualIDRegistry
							.getType(concreta.diagram.edit.parts.MKJAsociacionMultiplicidad2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new MKJAsociacionMultiplicidadTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MKJAsociacionMultiplicidadTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MKJAsociacionMultiplicidadTargetLabelFigure() {
			this.setText("MultiplicidadTarget");
		}
