 ...
 * @generated
 */
public class MKJAtributoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MKJAtributoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MKJAtributo_3001, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MKJAtributoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
