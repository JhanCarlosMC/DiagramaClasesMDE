 ...
 * @generated
 */
public class MKJMetodoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MKJMetodoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MKJMetodo_3002, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MKJMetodoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
