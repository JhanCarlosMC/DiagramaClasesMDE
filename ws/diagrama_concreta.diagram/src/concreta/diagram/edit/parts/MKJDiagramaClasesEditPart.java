...
import concreta.diagram.edit.policies.MKJDiagramaClasesCanonicalEditPolicy;
import concreta.diagram.edit.policies.MKJDiagramaClasesItemSemanticEditPolicy;
import concreta.diagram.part.ConcretaVisualIDRegistry;

/**
 * @generated
 */
public class MKJDiagramaClasesEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public MKJDiagramaClasesEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MKJDiagramaClasesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new MKJDiagramaClasesCanonicalEditPolicy());
