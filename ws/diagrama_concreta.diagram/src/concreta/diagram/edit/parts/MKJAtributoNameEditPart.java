 ...
 * @generated
 */
public class MKJAtributoNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MKJAtributoNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MKJAtributo_3001, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MKJAtributoNameEditPart.VISUAL_ID));
		}
		return parser;
	}
