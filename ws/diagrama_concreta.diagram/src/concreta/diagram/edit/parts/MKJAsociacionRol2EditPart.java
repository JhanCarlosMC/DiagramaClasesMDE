 ...
 * @generated
 */
public class MKJAsociacionRol2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MKJAsociacionRol2EditPart.VISUAL_ID),
				new Point(50, -5));
	}
	...
	* @generated
	*/
	public MKJAsociacionRol2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new MKJAsociacionTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MKJAsociacionTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MKJAsociacionTargetLabelFigure() {
			this.setText("Target");
		}
