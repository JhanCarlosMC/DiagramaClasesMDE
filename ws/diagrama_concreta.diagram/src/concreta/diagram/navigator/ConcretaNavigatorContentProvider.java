	...
	*/
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(
					createNavigatorItems(selectViewsByType(topViews, MKJDiagramaClasesEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MKJDiagramaClasesEditPart.VISUAL_ID: {
			...
			ConcretaNavigatorGroup links = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJDiagramaClases_1000_links, "icons/linksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJClaseEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJPaqueteEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJAsociacionEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJConteinmentEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJAgregacionEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJHerenciaEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJInterfaceEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			if (!links.isEmpty()) {
				result.add(links);
			}
		...
		case MKJClaseEditPart.VISUAL_ID: {
			...
			ConcretaNavigatorGroup incominglinks = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJClase_2001_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup outgoinglinks = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJClase_2001_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJClaseMKJClaseAtributosCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					ConcretaVisualIDRegistry.getType(MKJAtributoEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJClaseMKJClaseMetodosCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					ConcretaVisualIDRegistry.getType(MKJMetodoEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
		...
		case MKJAsociacionEditPart.VISUAL_ID: {
			...
			ConcretaNavigatorGroup target = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJAsociacion_4001_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup source = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJAsociacion_4001_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case MKJConteinmentEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ConcretaNavigatorGroup target = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJConteinment_4002_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup source = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJConteinment_4002_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJClaseEditPart.VISUAL_ID));
		...
		case MKJAgregacionEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ConcretaNavigatorGroup target = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJAgregacion_4003_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup source = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJAgregacion_4003_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJClaseEditPart.VISUAL_ID));
		...
		case MKJHerenciaEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ConcretaNavigatorGroup target = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJHerencia_4004_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup source = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJHerencia_4004_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJClaseEditPart.VISUAL_ID));
		...
		case MKJInterfaceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ConcretaNavigatorGroup target = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJInterface_4005_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup source = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MKJInterface_4005_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MKJClaseEditPart.VISUAL_ID));
