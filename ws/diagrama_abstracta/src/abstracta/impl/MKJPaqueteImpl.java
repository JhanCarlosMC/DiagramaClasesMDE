 ...
 * </p>
 * <ul>
 *   <li>{@link abstracta.impl.MKJPaqueteImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link abstracta.impl.MKJPaqueteImpl#getRuta <em>Ruta</em>}</li>
 *   <li>{@link abstracta.impl.MKJPaqueteImpl#getPaquetes <em>Paquetes</em>}</li>
 *   <li>{@link abstracta.impl.MKJPaqueteImpl#getClases <em>Clases</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MKJPaqueteImpl extends EObjectImpl implements MKJPaquete {
	...
	protected EClass eStaticClass() {
		return AbstractaPackage.Literals.MKJ_PAQUETE;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.MKJ_PAQUETE__NOMBRE, oldNombre, nombre));
	}
	...
	public void setRuta(String newRuta) {
		...
		ruta = newRuta;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.MKJ_PAQUETE__RUTA, oldRuta, ruta));
	}
	...
	public EList<MKJPaquete> getPaquetes() {
		if (paquetes == null) {
			paquetes = new EObjectContainmentEList<MKJPaquete>(MKJPaquete.class, this, AbstractaPackage.MKJ_PAQUETE__PAQUETES);
		}
		return paquetes;
	}
	...
	public EList<MKJClase> getClases() {
		if (clases == null) {
			clases = new EObjectContainmentEList<MKJClase>(MKJClase.class, this, AbstractaPackage.MKJ_PAQUETE__CLASES);
		}
		return clases;
	}
