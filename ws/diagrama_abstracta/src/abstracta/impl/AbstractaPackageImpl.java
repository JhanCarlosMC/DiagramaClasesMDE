...
public class AbstractaPackageImpl extends EPackageImpl implements AbstractaPackage {
	 ...
	 * @generated
	 */
	public EAttribute getMKJRelacion_Tipo() {
	...
	public EAttribute getMKJRelacion_Navegabilidad2() {
		return (EAttribute)mkjRelacionEClass.getEStructuralFeatures().get(7);
	}
	...
	public EReference getMKJRelacion_Target() {
		return (EReference)mkjRelacionEClass.getEStructuralFeatures().get(9);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(mkJmetodoEClass, MK_JMETODO__NOMBRE);
		createEAttribute(mkJmetodoEClass, MK_JMETODO__RETORNO);
		createEReference(mkJmetodoEClass, MK_JMETODO__LISTA_PARAMETROS);

		mkjRelacionEClass = createEClass(MKJ_RELACION);
		createEAttribute(mkjRelacionEClass, MKJ_RELACION__NAME);
		createEAttribute(mkjRelacionEClass, MKJ_RELACION__TIPO);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMKJRelacion_Tipo(), ecorePackage.getEString(), "tipo", null, 0, 1, MKJRelacion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
