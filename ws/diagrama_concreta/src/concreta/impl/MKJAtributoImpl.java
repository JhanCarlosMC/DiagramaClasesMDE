...
public class MKJAtributoImpl extends EObjectImpl implements MKJAtributo {
	...
	protected EClass eStaticClass() {
		return ConcretaPackage.Literals.MKJ_ATRIBUTO;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MKJ_ATRIBUTO__NOMBRE, oldNombre, nombre));
	}
	...
	public void setPrimaryKey(boolean newPrimaryKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MKJ_ATRIBUTO__PRIMARY_KEY, oldPrimaryKey, primaryKey));
	}
	...
	public void setForeignKey(boolean newForeignKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MKJ_ATRIBUTO__FOREIGN_KEY, oldForeignKey, foreignKey));
	}
