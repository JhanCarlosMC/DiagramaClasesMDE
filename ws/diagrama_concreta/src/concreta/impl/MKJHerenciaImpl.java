 ...
 * </p>
 * <ul>
 *   <li>{@link concreta.impl.MKJHerenciaImpl#getSource <em>Source</em>}</li>
 *   <li>{@link concreta.impl.MKJHerenciaImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MKJHerenciaImpl extends EObjectImpl implements MKJHerencia {
	...
	protected EClass eStaticClass() {
		return ConcretaPackage.Literals.MKJ_HERENCIA;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConcretaPackage.MKJ_HERENCIA__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(MKJClase newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MKJ_HERENCIA__SOURCE, oldSource, source));
	}
	...
	public MKJClase getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConcretaPackage.MKJ_HERENCIA__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(MKJClase newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MKJ_HERENCIA__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConcretaPackage.MKJ_HERENCIA__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case ConcretaPackage.MKJ_HERENCIA__TARGET:
